...
@rerun
  Scenario: Eddie Murphy user navigates to Developers menu
    Given User should be on the login page
  ...
  @rerun
  Scenario: Morgan Freeman user navigates to Dashboard menu
    Given User should be on the login page
  ...
  Scenario Outline: Different user <name> navigates to <tab> menu
    ...
    Examples:
      ...
      | mike@gmail.com          | mike1234 | Rabinson       | Edit Profile | Edit User Profile |
